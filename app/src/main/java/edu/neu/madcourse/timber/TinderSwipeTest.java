...
public class TinderSwipeTest extends AppCompatActivity {

    private static final String TAG = "TinderSwipeTest";
        ...
        manager = new CardStackLayoutManager(this, new CardStackListener() {
            ...
            public void onCardSwiped(Direction direction) {
                ...
                if (direction == Direction.Right){
                    Toast.makeText(TinderSwipeTest.this, "Direction Right", Toast.LENGTH_SHORT).show();
                }
                if (direction == Direction.Top){
                    Toast.makeText(TinderSwipeTest.this, "Direction Top", Toast.LENGTH_SHORT).show();
                }
                if (direction == Direction.Left){
                    Toast.makeText(TinderSwipeTest.this, "Direction Left", Toast.LENGTH_SHORT).show();
                }
                if (direction == Direction.Bottom){
                    Toast.makeText(TinderSwipeTest.this, "Direction Bottom", Toast.LENGTH_SHORT).show();
                }
